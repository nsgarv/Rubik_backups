...
int gDFDisplyInit(void)
{
   ...
   static far unsigned char *bp = DISPLAY_RX2_DMA_BUF;
   U16 temp;
...
int gDFDisplyProcessDisplayRequests()
{
   ...
   {
      if (((far char *)DISPLAY_RX2_DMA_BUF)[0] == '>')
      {
      ...
      else if (((far char *)DISPLAY_RX2_DMA_BUF)[0] == '!')
      {
...
static void SendRequest()
{
   ...
   ((far char *)DISPLAY_RX2_DMA_BUF)[0] = 0;
