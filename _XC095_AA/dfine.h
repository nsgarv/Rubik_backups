...
#define SWVER  "S/V x.095XC.AA" // Software version
...
#define CHECK_CRC 0    // 0 = Inhibits CRC during development & debugging,
...
//#define RAMSTART ((unsigned char *)0x0800) // start of RAM
//
//    used for hc/adaq/display
#define DMARAM ((__far unsigned char *)0x4000)   // MUST be declared __far
//#define DMARAM ((unsigned char *)0x4000)   // MUST be declared __far
...
#define RFON_LED        _LATD6
#define MOTOR_LED       _LATD7

/* This define is <IEC 62304 CLASS C> */

#define KICK_THE_DOG (_LATG15 = !(_LATG15 = 0)) // watchdog kick, toggle RG15, 500 ns
