...
#define RAMSTART ((far U8* )0x0800) // start of RAM

//    used for hc/adaq/display
#define DMARAM ((far U8* )0x4000)   // MUST be declared far
...
int  crcchk( far U8 *bp , unsigned bytes);
void crcgen( far U8 *bp , unsigned bytes);
